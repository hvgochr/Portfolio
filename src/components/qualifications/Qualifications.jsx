        ...
        <div className="qualification__sections">
          ...
          >
            ...
            <div className="qualification__data">
              ...
              <div>
                <h3 className="qualification__title">Architecture School</h3>
                <span className="qualification__subtitle">
                  ENSA Montpellier
                </span>
                <div className="qualification__calendar">
          ...
          >
            ...
            <div className="qualification__data">
              ...
              <div>
                <h3 className="qualification__title">
                  Seasonal employment at a laundry center
                </h3>
                <span className="qualification__subtitle">
                  Cleaning and calendering sheets
                </span>
                <div className="qualification__calendar">
                  <i className="uil uil-calendar-alt"></i> Summer 2019 - 2022
                </div>
              </div>
            </div>
            ...
            <div className="qualification__data">
              <div>
                <h3 className="qualification__title">
                  Civic service in an elementary school
                </h3>
                <span className="qualification__subtitle">
